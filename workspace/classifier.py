...
# When running code on my local machine i was prompted some arfuments were depreciated but when i changed it i got an error
# vgg16 = models.VGG16_Weights.DEFAULT
# resnet18=models.ResNet18_Weights.DEFAULT
# alexnetmodels.AlexNet_Weights.DEFAULT
...
def classifier(img_path, model_name):
    ...
    pred_idx = output.data.numpy()
    pred_idx=pred_idx.argmax()
